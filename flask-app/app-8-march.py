# %% [code] {"execution":{"iopub.status.busy":"2022-03-08T07:55:53.406152Z","iopub.execute_input":"2022-03-08T07:55:53.406504Z","iopub.status.idle":"2022-03-08T07:56:02.197925Z","shell.execute_reply.started":"2022-03-08T07:55:53.406475Z","shell.execute_reply":"2022-03-08T07:56:02.196922Z"},"jupyter":{"outputs_hidden":false}}
#!pip install tika
# !pip install pycaret
import tensorflow
import pandas as pd
...
# %% [code] {"execution":{"iopub.status.busy":"2022-03-08T07:48:30.392989Z","iopub.execute_input":"2022-03-08T07:48:30.393285Z","iopub.status.idle":"2022-03-08T07:48:30.686557Z","shell.execute_reply.started":"2022-03-08T07:48:30.39325Z","shell.execute_reply":"2022-03-08T07:48:30.685593Z"},"jupyter":{"outputs_hidden":false}}
class resume_spacy_pdf_clean_skills():
    ...
    def get_number_of_post(self, text_from_pdf):
        post = []
        pat2 = [r'\b(?i)' + 'senior' + r'\b', r'\b(?i)' + 'Trainee' + r'\b', r'\b(?i)' + 'post' + r'\b',
                r'\b(?i)' + 'reserch fellow' + r'\b', r'\b(?i)' + 'junior' + r'\b', r'\b(?i)' + 'nos' + r'\b',
                r'\b(?i)' + 'position' + r'\b', r'\b(?i)' + 'required' + r'\b', r'\b(?i)' + 'posting' + r'\b',
                r'\b(?i)' + 'vocation' + r'\b', r'\b(?i)' + 'vacancy' + r'\b', r'\b(?i)' + 'opening' + r'\b',
                r'\b(?i)' + 'place' + r'\b']
        sal = []
        for p in pat2:
            for i in text_from_pdf.lower().split("\n"):
...
# %% [code] {"execution":{"iopub.status.busy":"2022-03-08T07:56:07.191961Z","iopub.execute_input":"2022-03-08T07:56:07.192287Z","iopub.status.idle":"2022-03-08T07:56:08.825998Z","shell.execute_reply.started":"2022-03-08T07:56:07.19225Z","shell.execute_reply":"2022-03-08T07:56:08.824664Z"},"jupyter":{"outputs_hidden":false}}
# cols = ['job', 'skills_required', 'salary', 'job_description', 'salary']
...
def predict():
    ...
    p6 = ["agile", "deadline-oriented", "multitask", "pressure", "multitasking", "enthusiastic", "high energy",
          "committed", "proactive", "pressure", "independently", "entrepreneurial", "independent", "resourceful"]
